...
// Define the IGCSEQuiz schema inline
...
**Import Tool:** backend/src/scripts/importPhysicsProofOfConcept.js
...
`;
        ...
        const reportPath = path.join(reportsDir, `physics-proof-of-concept-${new Date().toISOString().slice(0, 19).replace(/:/g, '-')}.md`);
